import { GeocodingConfigurationError, GeocodingUpstreamError, rateLimitKey, reverseGeocode } from '../../lib/geocoding-gateway'
...
export const onRequestPost: PagesFunction<Env> = async context => {
  ...
  if (!success) {
    return route.failWithHeaders(429, 'Too many requests', { 'Retry-After': '60' }, 'Reverse geocoding exceeded the rate limit for this account; retry after the window closes')
  }
