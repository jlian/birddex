...
final class BirdIDParityTests: XCTestCase {
    ...
    ///
    /// This used to read a gitignored copy under Fixtures/, generated by
    ...
    static let shippedPriorName = "occurrence.d0abc168.bin.gz"

    /// The decompressed prior, inflated once. The shipped v4 blob is 32.93 MiB
    /// decompressed (34,534,667 bytes) from 21.54 MiB gzipped, and five tests
    /// read it. 23 MiB was v3.
...
extension BirdIDParityTests {
    ...
    static func gunzip(_ data: Data) throws -> [UInt8] {
        ...
        // -> slice -> [UInt8] -> Data and back, copying 33 MiB several times.
