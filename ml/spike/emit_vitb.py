...
os.makedirs(os.path.join(HERE,"bioclip-vitb-fixtures"),exist_ok=True)
for path in sorted(glob.glob(os.path.join(HERE,"images","*"))):
    ...
    out=os.path.join(HERE,"bioclip-vitb-fixtures",fn.rsplit(".",1)[0]+".json")
    json.dump(fx,open(out,"w"),indent=1)
print("wrote bioclip-vitb-fixtures/")
